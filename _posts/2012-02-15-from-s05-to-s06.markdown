...
The problem of removing every second box from the list of boxes is resolved by using a list of boxes. 

**Code 05-06.14**: Iterating over a list of boxes.
...
A number of selected boxes is detrmined by the countSelectedBoxes method of the Board class. 
