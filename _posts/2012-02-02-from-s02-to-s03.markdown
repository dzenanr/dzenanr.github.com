...
A new box created by the constructor of the Box class is added to the boxes attribute. The add method belongs to the [List abstract class](https://api.dartlang.org/docs/channels/stable/latest/dart_core/List.html). 
